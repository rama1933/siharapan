...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <!--  start blog left-->
            <div class="col-lg-12 col-md-12 sm-margin-50px-bottom mt-5">
                <div class="posts">
                    <!--  start post-->
                    <div class="post">
                        <div class="post-img">
                            <img src="{{ asset('') }}/{{ $berita->path }}" class="card-img-top rounded"
                                style="max-height:650px;max-width:100%" alt="">
                        </div>
                        <div class="content">
                            ...
                            <div class="margin-30px-bottom" style="text-align: justify;">
                                <p class="margin-30px-bottom">{!! $berita->berita !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
