...
<body>
            ...
            <div class="row">
                <div class="card-body" style="background-color: white">
                    <div class="row justify-content-center">
                        ...
                        <div>
                            <p>Tanggal Mulai</p>
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" style="min-height: 42px"
                                class="form-control" onchange="filter_pasar()">
                        </div>

                        <div>
                            <p>Tanggal Akhir</p>
                            <input type="date" name="tanggal_akhir" id="tanggal_akhir" style="min-height: 42px"
                                class="form-control" onchange="filter_pasar()">
                        </div>
    ...
    <script>
        var options = {
            series: [{
                ...
                },
                {
                    name: 'Pasar Negara',
                    data: [
                        @foreach ($harga_chart_negara as $negara)
                            {{ $negara->harga_hari_ini }},
                        @endforeach
                    ]
                },
                {
                    name: 'IHK Banjarmasin',
                    data: [
                        @foreach ($harga_chart_bjm as $bjm)
                            {{ $bjm->harga_hari_ini }},
                        @endforeach
                    ]
                },
        ...
        function filter_pasar() {
            ...
            $.ajax({
                url: window.location.origin + '/landing/filter/grafik',
                method: "POST",
                headers: {
