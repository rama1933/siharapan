    ...
    <table class="table table-bordered table-striped  table-md" id="table">
        <thead>
            ...
            <tr>
                <th colspan="7" style="vertical-align: middle;text-align:center;width:130px">
                    <h1>
                        Sistem Informasi Harga Pokok IHK Banjarmasin
                        @if ($tanggal != null)
            ...
            <tr>
                <th rowspan="2" style="color: vertical-align: middle;text-align:center;width:130px">
                    No
                </th>
                <th rowspan="2" style="color: vertical-align: middle;text-align:center;width:130px">
                    Nama Bahan
                ...
                <th rowspan="1" colspan="4" style="color: vertical-align: middle;text-align:center">Pasar
                    Banjarmasin</th>
                <th rowspan="2" style="color: vertical-align: middle;text-align:center">
                    Persediaan
                </th>
            </tr>
            <tr>
                ...
                <th
                    style="color: vertical-align: middle;text-align:center;padding-right:20px;padding-left:20px;border-spacing: 0px;white-space: nowrap;">
                    Harga Hari Ini</th>
                <th
                    style="color: vertical-align: middle;text-align:center;padding-right:20px;padding-left:20px;border-spacing: 0px;white-space: nowrap;">
                    Harga Kemarin</th>
