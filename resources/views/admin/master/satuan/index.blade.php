...
@push('page-styles')
    ...
    <style>
        ...
        /* PERBAIKAN: Menambahkan garis dan styling pada tabel */
        #satuan-table {
...
@section('content')
    {{-- Komponen utama yang dikontrol oleh Alpine.js untuk state modal --}}
    <div x-data="{ createModalOpen: false, editModalOpen: false, editData: {} }" @close-modals.window="createModalOpen = false; editModalOpen = false">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Manajemen Satuan</h1>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="p-6">
                <div class="overflow-x-auto">
                    <table class="w-full" id="satuan-table">
                        <thead>
                            <tr>
        ...
        <div x-show="createModalOpen" @keydown.escape.window="createModalOpen = false"
            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div @click.away="createModalOpen = false" x-show="createModalOpen"
                    ...
                    <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Tambah Satuan Baru</h3>
        ...
        <div x-show="editModalOpen" @keydown.escape.window="editModalOpen = false"
            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div @click.away="editModalOpen = false" x-show="editModalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                    class="inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Satuan</h3>
                    <form id="form-edit" class="mt-4 space-y-6">
                        @csrf
                        <input type="hidden" name="id" x-model="editData.id">
                        <div>
                            <label for="namaEdit" class="block text-sm font-medium text-gray-700">Nama Satuan</label>
...
@push('page-scripts')
    ...
    <script>
        ...
        function editSatuan(id) {
            $.ajax({
                url: `/master/data/show?type=satuan&id=${id}`,
        ...
        $(document).ready(function() {
            ...
            $('#satuan-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.data', ['type' => 'satuan']) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
                ...
                $(this).ajaxSubmit({
                    ...
                    success: function(res) {
                        if (res.status === "success") {
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: 'Gagal: Nama satuan sudah ada.'
                            });
                        }
                    }
                });
